...
const data = {
  ...
  mobile_home: "../vysio/home.jpg",
  mobile_session_prep: "../vysio/session_prep.jpg",
  mobile_session: "../vysio/session.jpg",
  mobile_notes: "../vysio/notes.jpg",
  mobile_summary: "../vysio/summary.jpg"
}
  ...
  return (
    <main class="min-h-screen min-w-screen dark:bg-black">
      ...
      <div class="mx-auto w-full sm:w-3/4 lg:w-2/3 xl:w-1/2 py-2 md:py-4 lg:py-8 space-y-3 bg-white">
        ...
        <p class="text-gray-600 dark:text-white">We made some extra work for ourselves by deciding our solution should consist of a web applications, an iOS app and an Arduino wearable that feeds data into an ML model. Check out how users interact with these components:</p>
        <div class="py-2 flex flex-row justify-between">
          ...
          <div class="text-gray-600 rounded-lg m-4 drop-shadow-md p-4">
            ...
            <p class="text-gray-600 dark:text-white">Mobile app to record their at-home exercise sessions and provide notes to their practitioner. Client’s wear an arduino wearable so that their exercises can be recorded and classified.</p>
          </div>
        </div>
      </div>
      ...
      <div class="w-full bg-gray-100 flex justify-center">
        <div class="pt-6 pb-6">
          <p class="text-2xl text-gray-600">🚧 Article under construction. Check back soon! 🛠</p>
        </div>
      </div>
    </main>
  )
